...
import br.com.anteros.collections.queue.file.processor.Consumer;
import br.com.anteros.collections.queue.file.processor.Expiration;
import br.com.anteros.collections.queue.file.processor.QueueProcessor;
import br.com.anteros.collections.utils.AdjustableSemaphore;


/**
 * AnterosFileQueue is a fast and efficient persistent filequeue written in Java. FileQueue is backed by H2 Database MVStore.
 ...
 * <p>
 */
public final class AnterosFileQueue<T> {
    ...
    /**
     * Create @{@link AnterosFileQueue}.
     */

    public AnterosFileQueue() {
    }
    ...
    public static class Config<T> {
        ...
        public Config type(Type type) throws IllegalArgumentException {
            if (type == AnterosFileQueueItem.class || !AnterosFileQueueItem.class.isAssignableFrom(type.getClass()))
    ...
    public static  Config config(String queueName, Path queuePath, Class type, Consumer consumer) {
        return new Config<AnterosFileQueueItem>(queueName, queuePath, type, consumer);
    }
    ...
    public static <T> AnterosFileQueue<T> fileQueue() { 
    	return new AnterosFileQueue<T>(); 
    }
